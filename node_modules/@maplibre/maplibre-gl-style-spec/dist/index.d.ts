//#region src/reference/v8.json.d.ts
...
//#endregion
//#region src/reference/latest.d.ts
/**
 * The style specification reference, i.e. the contents of `v8.json`, Inferred from the JSON itself.
 */
type StyleSpecificationReference = typeof _exports;
declare const latest: StyleSpecificationReference;
//#endregion
...
type LayerWithRef = LayerSpecification & {
  ref?: string;
};
/**
 *
 ...
 */
declare function derefLayers(layers: LayerWithRef[]): LayerSpecification[];
//#endregion
 ...
 */
declare function diff(before: StyleSpecification, after: StyleSpecification): DiffCommand<DiffOperations>[];
//#endregion
...
//#endregion
//#region src/expression/parsing_error.d.ts
...
//#endregion
//#region src/expression/evaluation_context.d.ts
...
type ProjectionDefinitionTypeT = {
...
type NumberArrayTypeT = {
  kind: 'numberArray';
};
type ColorArrayTypeT = {
  kind: 'colorArray';
};
type ResolvedImageTypeT = {
  kind: 'resolvedImage';
};
type VariableAnchorOffsetCollectionTypeT = {
  kind: 'variableAnchorOffsetCollection';
};
type EvaluationKind = 'constant' | 'source' | 'camera' | 'composite';
type Type = NullTypeT | NumberTypeT | StringTypeT | BooleanTypeT | ColorTypeT | ProjectionDefinitionTypeT | ObjectTypeT | ValueTypeT | ArrayType | ErrorTypeT | CollatorTypeT | FormattedTypeT | PaddingTypeT | NumberArrayTypeT | ColorArrayTypeT | ResolvedImageTypeT | VariableAnchorOffsetCollectionTypeT;
interface ArrayType<T extends Type = Type> {
  kind: 'array';
  itemType: T;
  N: number;
}
declare const NullType: NullTypeT;
declare const ColorType: ColorTypeT;
declare const ProjectionDefinitionType: ProjectionDefinitionTypeT;
declare const FormattedType: FormattedTypeT;
...
declare function typeOf(value: Value): Type;
//#endregion
//#region src/expression/scope.d.ts
/**
...
//#endregion
//#region src/expression/parsing_context.d.ts
/**
...
//#endregion
//#region src/expression/expression.d.ts
/**
 * Expression
 */
...
type ExpressionParser = (args: ReadonlyArray<unknown>, context: ParsingContext) => Expression;
...
//#endregion
//#region src/util/interpolate-primitives.d.ts
...
//#endregion
//#region src/expression/stops.d.ts
...
declare class Interpolate implements Expression {
  ...
  constructor(type: InterpolatedValueType, operator: 'interpolate' | 'interpolate-hcl' | 'interpolate-lab', interpolation: InterpolationType, input: Expression, stops: Stops, key: string);
...
declare function createFunction(parameters: any, propertySpec: any): StyleFunction;
//#endregion
...
declare class StyleExpression {
  ...
  constructor(expression: Expression, rootKey: string, propertySpec?: StylePropertySpecification | null, globalState?: Record<string, any>);
 ...
 * @private
 */
declare function createExpression(expression: unknown, rootKey: string, propertySpec?: StylePropertySpecification | null, globalState?: Record<string, any>): Result<StyleExpression, Array<ExpressionParsingError>>;
...
declare function isZoomExpression(expression: any): expression is ZoomConstantExpression<'source'> | ZoomDependentExpression<'source'>;
...
declare function createPropertyExpression(expressionInput: unknown, rootKey: string, propertySpec: StylePropertySpecification, globalState?: Record<string, any>): Result<StylePropertyExpression, Array<ExpressionParsingError>>;
declare class StylePropertyFunction<T> {
  ...
  globalStateRefs: Set<string>;
  readonly _globalState: Record<string, any>;
  constructor(parameters: PropertyValueSpecification<T>, rootKey: string, specification: StylePropertySpecification);
  /**
...
declare function normalizePropertyExpression<T>(value: PropertyValueSpecification<T>, rootKey: string, specification: StylePropertySpecification, globalState?: Record<string, any>): StylePropertyExpression;
//#endregion
 ...
 */
declare function featureFilter(filter: FilterSpecification | void, rootKey: string, globalState?: Record<string, any>): FeatureFilter;
//#endregion
//#region src/feature_filter/convert.d.ts
type ExpectedTypes = {
  [_: string]: ExpressionInputType;
};
declare function convertFilter(filter: FilterSpecification, expectedTypes?: ExpectedTypes): ExpressionFilterSpecification;
//#endregion
//#region src/function/convert.d.ts
...
//#endregion
//#region src/util/properties.d.ts
declare function supportsPropertyExpression(spec: StylePropertySpecification): boolean;
//#endregion
//#region src/expression/definitions/index.d.ts
declare const expressions: ExpressionRegistry;
//#endregion
//#region src/group_by_layout.d.ts
/**
 ...
 */
declare function groupByLayout(layers: LayerSpecification[], cachedKeys?: Record<string, string>): LayerSpecification[][];
//#endregion
//#region src/empty.d.ts
declare function emptyStyle(): StyleSpecification;
//#endregion
//#region src/validate_style.min.d.ts
/**
 ...
 */
declare function validateStyleMin(style: StyleSpecification, styleSpec?: {
  $version: number;
  $root: {
    version: {
      required: boolean;
...
//#endregion
//#region src/expression/definitions/step.d.ts
...
//#endregion
//#region src/expression/definitions/format.d.ts
...
declare class FormatExpression implements Expression {
  type: Type;
...
//#endregion
//#region src/expression/definitions/literal.d.ts
...
//#endregion
//#region src/expression/compound_expression.d.ts
type Varargs = {
  type: Type;
};
 ...
 */
declare function migrate(style: StyleSpecification): StyleSpecification;
//#endregion
//#region src/util/classify_rings.d.ts
type RingWithArea<T extends Point2D> = T[] & {
  area?: number;
};
/**
 ...
 */
declare function classifyRings<T extends Point2D>(rings: RingWithArea<T>[], maxRings?: number): RingWithArea<T>[][];
//#endregion
 ...
 */
declare function createVisibility(visibility: VisibilitySpecification, rootKey: string, globalState: Record<string, any>): VisibilityExpression;
//#endregion
...
//#endregion
export { type AllLayoutProperties, type AllPaintProperties, type BackgroundLayerSpecification, type CameraFunctionSpecification, type CircleLayerSpecification, type CollatorExpressionSpecification, Color, ColorArray, type ColorArraySpecification, type ColorReliefLayerSpecification, type ColorSpecification, ColorType, type CompositeExpression, type CompositeFunctionSpecification, CompoundExpression, type DataDrivenPropertyValueSpecification, type DiffCommand, type DiffOperations, EvaluationContext, type Expression, type ExpressionFilterSpecification, type ExpressionInputType, type ExpressionSpecification, type Feature, type FeatureFilter, type FeatureState, type FillExtrusionLayerSpecification, type FillLayerSpecification, type FilterSpecification, type FontFacesSpecification, FormatExpression, Formatted, FormattedSection, type FormattedSpecification, FormattedType, type GeoJSONSourceSpecification, type GlobalProperties, type HeatmapLayerSpecification, type HillshadeLayerSpecification, type ICanonicalTileID, type ILngLat, type ILngLatLike, type IMercatorCoordinate, type ImageSourceSpecification, Interpolate, type InterpolationSpecification, type InterpolationType, type LayerSpecification, type LegacyFilterSpecification, type LightSpecification, type LineLayerSpecification, Literal, type MLFontFace, NullType, NumberArray, type NumberArraySpecification, Padding, type PaddingSpecification, ParsingError, type Point2D, ProjectionDefinition, type ProjectionDefinitionSpecification, type ProjectionDefinitionT, ProjectionDefinitionType, type ProjectionSpecification, type PromoteIdSpecification, type PropertyValueSpecification, type RasterDEMSourceSpecification, type RasterLayerSpecification, type RasterSourceSpecification, ResolvedImage, type ResolvedImageSpecification, type SchemaSpecification, type SkySpecification, type SourceExpression, type SourceFunctionSpecification, type SourceSpecification, type SpriteSpecification, type StateSpecification, Step, StyleExpression, type StylePropertyExpression, StylePropertyFunction, StylePropertySpecification, type StyleSpecification, type StyleSpecificationReference, type SymbolLayerSpecification, type TerrainSpecification, type TransitionSpecification, type Type, ValidationError, type ValidationSeverity, VariableAnchorOffsetCollection, type VariableAnchorOffsetCollectionSpecification, type VariableExpressionSpecification, type VectorSourceSpecification, type VerticalAlign, type VideoSourceSpecification, type VisibilityExpression, type VisibilitySpecification, ZoomConstantExpression, ZoomDependentExpression, classifyRings, convertFilter, convertFunction, createExpression, createFunction, createPropertyExpression, createVisibility as createVisibilityExpression, derefLayers, diff, emptyStyle, expression, expressions, featureFilter, format, styleFunction as function, groupByLayout, interpolateFactory as interpolates, isExpression, isFunction, isZoomExpression, latest, latest as v8, migrate, normalizePropertyExpression, supportsPropertyExpression, typeToString as toString, typeOf, validate, validateStyleMin, visit };